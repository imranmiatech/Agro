    ...
    <div className='border-t-2 pt-10 transition-opacity ease-in duration-500 opacity-100'>
      ...
      <div className='mt-20'>
        ...
        <div className="flex flex-col gap-4 border px-6 py-6 text-sm text-gray-500">
           <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Ullam, ab. Tempore fugit nihil et reprehenderit porro ullam eos magni corporis? Accusamus quo magni, molestias recusandae pariatur rem tempore saepe facilis.</p>
            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Ullam, ab. Tempore fugit nihil et reprehenderit porro ullam eos magni corporis? Accusamus quo magni, molestias recusandae pariatur rem tempore saepe facilis.</p>
        </div>
      </div>
